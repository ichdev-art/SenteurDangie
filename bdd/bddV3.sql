...
INSERT INTO `76_admin` VALUES (1,'Mattong','$2y$10$zSrxdVrZaeY6IA6/Vdm/Bumkl44VIiHRYw29SGGLYkbrupl52nfOm');
...
CREATE TABLE `76_avis` (
  ...
  CONSTRAINT `76_avis_ibfk_1` FOREIGN KEY (`pro_id`) REFERENCES `76_produits` (`pro_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
INSERT INTO `76_avis` VALUES (1,'Très bon produit, je recommande !','2025-04-01',1,1),(3,'Bonne qualité mais livraison lente.','2025-04-02',3,3),(5,'J’adore le parfum de cette bougie.','2025-04-03',5,5),(7,'Ma préférée, douce et apaisante.','2025-04-05',7,2),(8,'Un classique, toujours aussi bien.','2025-04-05',1,3),(10,'Livraison rapide et soignée.','2025-04-07',3,5);
...
INSERT INTO `76_commande_ligne` VALUES (1,1,1),(1,8,3),(3,1,1),(3,3,1),(3,10,2),(5,5,1),(7,7,1);
...
INSERT INTO `76_produits` VALUES (1,'Composition','Composition florale gourmande.',37,10,'composition37e.jpg'),(3,'Gourmande Chocolats','Gourmande au goût chocolate',15,10,'gourmandechocolat15e.jpg'),(5,'Gourmande Rose','Gourmande douce parfumée à la rose.',15,10,'gourmanderose15e.jpg'),(7,'Gourmande Violette','Gourmande délicate à la violette.',15,10,'gourmandeviolett15e.jpg'),(29,'Pomme de pin','Bougie parfumée évoquant la fraîcheur boisée de la pomme de pin, idéale pour créer une ambiance chaleureuse et naturelle. Son design rustique s’inspire des forêts d’hiver, apportant une touche authentique à votre intérieur.',10,15,'681f3c778be6e_pommedepin.jpg'),(31,'Fraise nain de jardin','Ajoutez une touche de fantaisie fruitée à votre intérieur avec cette bougie artisanale en forme de nain de jardin, délicieusement parfumée à la fraise.',10,25,'681f42a98da01_fraisenaindejardin.jpg');
...
-- Dump completed on 2025-05-14 21:44:25
